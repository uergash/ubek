...
struct ImportContactsView: View {
    ...
    private var prompt: some View {
        VStack(spacing: 14) {
            ...
            Text("We'll only read the contacts you select. Names, phone numbers, and birthdays you tap \"Add\" become profiles in Bowline.")
    ...
    private var denied: some View {
        VStack(spacing: 14) {
            ...
            Text("Contacts access is off")
                .font(.system(size: 17, weight: .semibold))
            Text("Open Settings to allow Bowline to read your contacts, or skip this step.")
                .font(.system(size: 14))
                .foregroundStyle(Color.inkSoft)
                .multilineTextAlignment(.center)
                .padding(.horizontal, 32)
